...
COPY public.tb_project (id_project, date, name, analyst, category) FROM stdin;
...
1	Fachrul M	fachrulmustofa100@gmail.com	default.png	$2y$10$u3u9mtIaUBssmsQ3UoG49OgjdeJS6dICAaW3DS3T7NAahtpHUxkne	1	1	1581499816
4	Fachrul M	fachrulmustofa300@gmail.com	default.png	$2y$10$mPOL0g7KK7K3TYJ6jMDHG.t3S1WhRuCyFiasp0V33tFxOjRKsB4GW	2	1	1581569209
\.
...
SELECT pg_catalog.setval('public.tb_project_id_project_seq', 5, true);
...
SELECT pg_catalog.setval('public.user_token_id_seq', 4, true);
